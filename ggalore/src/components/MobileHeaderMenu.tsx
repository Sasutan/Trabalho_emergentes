  ...
  return (
    <>
      ...
      <div
        ...
        id="navbar-default"
      >
        <div className="font-medium flex flex-col p-4 md:p-0 mt-4 border rounded-sm md:flex-row md:space-x-4 rtl:space-x-reverse md:mt-0 md:border-0 border-text-gray">
          <Link
            href="/adicionar"
